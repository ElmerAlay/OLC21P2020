...
public class GTE implements ASTNode{
    ...
    public GTE(ASTNode op1, ASTNode op2, int row, int column) {
        super();
        this.op1 = op1;
        this.op2 = op2;
        this.row = row;
    ...
    public Object execute(Environment environment, LinkedList<TError> LError) {
        ...
        if(op1 instanceof Vec && op2 instanceof Vec){
            ...
            if(mat1.row==mat2.row && mat1.col==mat2.col){
                ...
                Object res = new GTE(new Constant(new Vec(o1)), new Constant(new Vec(o2)), row, column).execute(environment, LError);
            ...
            if(vec.length==1){
                ...
                Object res = new GTE(new Constant(new Vec(o1)), new Constant((Vec)op2), row, column).execute(environment, LError);
                Object result[][] = new Object[mat1.row][mat1.col];
                con1 = 0;
                if(res instanceof Vec){
                    for(int i=0;i<mat1.col;i++){
            ...
            if(vec.length==1){
                ...
                Object res = new GTE(new Constant((Vec)op1), new Constant(new Vec(o1)), row, column).execute(environment, LError);
                Object result[][] = new Object[mat1.row][mat1.col];
                con1 = 0;
                if(res instanceof Vec){
                    for(int i=0;i<mat1.col;i++){
